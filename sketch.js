...
function setup() 
{
  ...
  circle1 = new ball (40,100,30);
  circle2 = new ball (130,100,30);
  circle3 = new ball (220,100,30);
  circle4 = new ball (310,100,30);
  circle5 = new ball (400,100,30);
  
  circle7 = new ball (495,100,30);
  circle8 = new ball (590,100,30);
  circle9 = new ball (670,100,30);
  circle10 = new ball (750,100,30);
  circle11 = new ball (830,100,30);
  ...
  circle26 = new ball (40,260,30);
  circle27 = new ball (130,260,30);
  circle28 = new ball (220,260,30);
  circle29 = new ball (310,260,30);
  circle30 = new ball (400,260,30);
  circle31 = new ball (590,260,30);
  circle32 = new ball (670,260,30);
  circle33 = new ball (750,260,30);
  circle34 = new ball (830,260,30);
  circle35 = new ball (495,260,30);
